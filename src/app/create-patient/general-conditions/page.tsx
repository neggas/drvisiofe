    ...
    <DynamicHtmlTag type="div" className="md:px-5 situation-screen-main h-full">
        ...
        <DynamicHtmlTag type="div" className="flex w-full flex-col md:flex-row gap-x-10 justify-between">
          ...
          <DynamicHtmlTag type="div" className="w-full xl:w-1/2">
            ...
            <DynamicHtmlTag type="div" className="rounded-lg border border-gray-200 p-3">
              <HeadingTag type="h2" className="text-xs lg:text-sm font-bold border-b-2 pb-2 me-3">
          ...
          <DynamicHtmlTag type="div" className="w-full xl:w-1/2">
            <HeadingTag type="h4" className="text-xs lg:text-sm text-primary opacity-85 font-bold my-3">
              Notice d’information et de consentement
            </HeadingTag>
            <DynamicHtmlTag type="div" className="rounded-lg border border-gray-200 p-3">
              <HeadingTag type="h2" className="text-sm font-bold border-b-2 pb-2 me-4">
                NOTICE D’INFORMATION ET DE CONSENTEMENT
              </HeadingTag>
              <DynamicHtmlTag
      ...
      {isValidateTermError && (
        <CustomLabel className="text-red-500 text-2xs font-semibold">
          {`Pour accéder à votre espace Patient, vous devez lire et valider les conditions générales d'utilisation et la notice d'information.`}
        </CustomLabel>
      )}
      ...
      <DynamicHtmlTag type="div" className="flex flex-col md:flex-row lg:mt-4">
        <DynamicHtmlTag type="div" className="w-full md:w-9/12">
          <DynamicHtmlTag
            type="div"
            className={`${!isCguScrollToBottom ? "opacity-40" : ""} custom-checkbox notice [&&]:flex items-start gap-2 mb-2"`}>
            <CustomInput
              className=""
              type="checkbox"
              checked={isAcceptCgu}
            ...
            <DynamicHtmlTag type="span" className="text-xs opacity-40 font-medium">
              J{`'`}ai lu et j{`'`}accepte les conditions générales dutilisation et les conditions générales de vente de DrVisio.
            </DynamicHtmlTag>
          </DynamicHtmlTag>
          <DynamicHtmlTag
            type="div"
            className={`${!isNoticeScrollToBottom ? "opacity-40" : ""} custom-checkbox notice [&&]:flex items-start gap-2 mb-2"`}>
            <CustomInput
            ...
            <DynamicHtmlTag type="span" className="text-xs opacity-40 font-medium">
              J{`'`}ai lu, j{`'`}ai compris et j{`'`}accepte le traitement de mes données de santé pour le service DrVisio précisé dans la notice d
              {`'`}information et de consentement.
            </DynamicHtmlTag>
          </DynamicHtmlTag>
          <DynamicHtmlTag type="div" className={`custom-checkbox notice [&&]:flex items-start gap-2 mb-2"`}>
            <CustomInput
              className=""
              type="checkbox"
        ...
        <DynamicHtmlTag type="div" className="flex w-full md:w-3/12 h-auto">
          <CustomButton
            className={`text-sm cstm-btn ms-auto [&&]:mt-auto flex py-2 px-1 justify-center w-5/6 sm:w-8/12 md:w-full xl:w-10/12 view-more-btn rounded-xl text-white font-semibold`}
