...
const PractitionerOtherDocument = () => {
  ...
  return (
    <DynamicHtmlTag type="div" className="rounded-t-lg h-full overflow-auto">
      <DynamicHtmlTag type="div" className="tabs-content rounded-lg pt-0" id="other-doc">
              ...
              <tr className="cursor-pointer text-xs font-bold border-none lg:border-b lg:border-slate-100">
                <td className="py-3 px-3">
                  <DynamicHtmlTag type="div" className="flex gap-3 lg:gap-5">
                    ...
                    <DynamicHtmlTag type="span">Autre document</DynamicHtmlTag>
                  </DynamicHtmlTag>
                </td>
...
export default PractitionerOtherDocument;
