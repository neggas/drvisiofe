...
const PractitionerAdministrativeDocument = () => {
  ...
  return (
    <DynamicHtmlTag type="div" className="rounded-t-lg h-full overflow-auto">
      <DynamicHtmlTag type="div" className="tabs-content rounded-lg pt-0" id="administer">
...
export default PractitionerAdministrativeDocument;
