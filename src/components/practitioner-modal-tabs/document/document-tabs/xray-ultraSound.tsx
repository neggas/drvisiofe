...
const PractitionerXRayUltraSound = () => {
  ...
  const isDeleteDisabled = !Object.values(checkboxes).every(value => value === true);
  ...
  return (
    <DynamicHtmlTag type="div" className="rounded-t-lg h-full overflow-auto">
      <DynamicHtmlTag type="div" className="tabs-content rounded-lg pt-0" id="ultraSound">
        <HeadingTag type="h3" className="font-semibold text-sm text-white text-center py-1 px-3">
          Radio, écho, scanner, IRM
        </HeadingTag>
      </DynamicHtmlTag>
      <DynamicHtmlTag type="div" className="w-full px-3 py-2 relative rounded-b-lg">
        <DynamicHtmlTag type="div" className="max-h-table overflow-auto min-w-full bg-white">
          <table className="min-w-full bg-white">
            <thead>
              <tr className="sticky top-0 z-10 border-b border-slate-100">
                ...
                <th className="py-2 px-2 text-left font-medium text-slate-100 text-xs hidden md:table-cell">Examen de</th>
                <th className="py-2 px-2 text-left font-medium text-slate-100 text-xs hidden md:table-cell">Latéralité</th>
              ...
              <tr className="cursor-pointer text-xs font-bold border-none lg:border-b lg:border-slate-100">
                <td className="py-3 px-3">
                  <DynamicHtmlTag type="div" className="flex gap-3 lg:gap-5">
                    ...
                    <DynamicHtmlTag type="span">Mammographie</DynamicHtmlTag>
                  </DynamicHtmlTag>
                </td>
                ...
                <td className="py-3 px-3 text-center lg:text-left hidden lg:table-cell">
                  <DynamicHtmlTag type="span">Sein</DynamicHtmlTag>
                </td>
                <td className="py-3 px-3 text-center lg:text-left hidden lg:table-cell">
                  <DynamicHtmlTag type="span">Droit</DynamicHtmlTag>
                </td>
                ...
                <td className="py-3 px-3 w-1/6">
                  <DynamicHtmlTag type="div" className="flex items-center space-x-2 lg:space-x-4 justify-center">
                    ...
                    <CustomButton className="cursor-pointer" as="button">
                      <CustomImage
                        className="w-5 h-5 max-w-max cursor-pointer"
          ...
          <DynamicHtmlTag type="div" className="flex gap-3 w-full lg:hidden">
            <DynamicHtmlTag type="div" className="flex gap-2">
              <DynamicHtmlTag type="span" className="text-gray-500">
                Examen de
              </DynamicHtmlTag>
...
export default PractitionerXRayUltraSound;
