...
import { getteleconsultationpatientApi, PatientTeleconsultationsNearbyResponse, teleconsultationListMedicalSituationDocumentApi } from "@/utility";
  ...
  return (
    <DynamicHtmlTag type="div" className="bg-white rounded-xl h-auto lg:h-[92%]">
      ...
      {Teleconsultations.length === 0 ? (
        ...
        // <DynamicHtmlTag
        //   type="span"
        //   className="max-w-max text-center text-sm py-1 md:absolute top-1/2 lg:left-1/2 -translate-x-1/2 -translate-y-1/2 empty-image-main">
        //   <CustomImage src={VisioLogo} alt="logo" className="loader-logo mx-auto mb-2" width={500} height={200} />
        //   Aucune téléconsultation n{`'`}a été effectuée pour le moment.
        // </DynamicHtmlTag>
        <DynamicHtmlTag type="div" className="px-3 lg:px-4 h-[96%] xl:h-full overflow-hidden">
          ...
          <DynamicHtmlTag type="div" className="flex mt-2 xl:mt-5 border-b-2 pb-2">
            <DynamicHtmlTag
              type="p"
              className="text-3xs md:text-[1.5vw] lg:text-[.6vw] xl:text-[.6vw] text-slate-100 font-bold text-left w-5/12 lg:w-3/12">
              Date et heure
            </DynamicHtmlTag>
            <DynamicHtmlTag type="p" className="text-3xs md:text-[1.5vw] lg:text-[.6vw] xl:text-[.6vw] text-slate-100 font-bold text-left w-4/12">
              Médecin
            </DynamicHtmlTag>
            <DynamicHtmlTag
              type="p"
              className="text-3xs md:text-[1.5vw] lg:text-[.6vw] xl:text-[.6vw] text-slate-100 font-bold text-left hidden lg:block w-3/12">
              Bénéficiare
            </DynamicHtmlTag>
            <DynamicHtmlTag
              type="p"
              className="text-3xs md:text-[1.5vw] lg:text-[.6vw] xl:text-[.6vw] text-slate-100 font-bold text-left hidden lg:block w-2/12">
              Statut
            </DynamicHtmlTag>
          </DynamicHtmlTag>
          {/* Table Header End  */}
                ...
                {Teleconsultations.map((item: any, index: number) => {
                  ...
                  return (
                    <DynamicHtmlTag type="div" key={index}>
                      <DynamicHtmlTag type="div" className="flex mt-1 pb-0 lg:pb-2 items-center">
                        <DynamicHtmlTag
                          type="div"
                          className="text-3xs md:text-[1.5vw] lg:text-[.5vw] xl:text-[.6vw] text-black font-bold w-5/12 lg:w-3/12">
                          {item?.startDate} - {item?.startTime}
                        </DynamicHtmlTag>
                        <DynamicHtmlTag
                          type="div"
                          className="text-3xs md:text-[1.5vw] lg:text-[.5vw] xl:text-[.6vw] text-black font-bold flex items-center gap-2 w-7/12 lg:w-4/12 text-left">
                          <CustomImage
                        ...
                        <DynamicHtmlTag
                          type="div"
                          className="text-3xs md:text-[1.5vw] lg:text-[.5vw] xl:text-[.6vw] text-black font-bold w-3/12 hidden lg:block capitalize">
                          {`${item?.patient.firstName} ${item?.patient.lastName}`}
                        </DynamicHtmlTag>
                        <DynamicHtmlTag
                          type="div"
                          className="text-3xs md:text-[1.5vw] lg:text-[.5vw] xl:text-[.6vw] text-black font-bold text-left w-2/12 hidden lg:block">
                          {item?.status}
                        </DynamicHtmlTag>
                      </DynamicHtmlTag>
                      <DynamicHtmlTag type="div" className="flex justify-between items-center lg:hidden">
                        <DynamicHtmlTag
                          type="p"
                          className="text-3xs md:text-[1.5vw] lg:text-[.5vw] xl:text-[.6vw] text-slate-100 font-bold text-left">
                          Bénéficiare :
                          <DynamicHtmlTag type="span" className="text-3xs md:text-[1.5vw] lg:text-[.5vw] xl:text-[.6vw] text-black font-bold ps-1">
                            {`${item?.patient.firstName} ${item?.patient.lastName}`}
                          </DynamicHtmlTag>
                        </DynamicHtmlTag>
                        <DynamicHtmlTag
                      ...
                      <DynamicHtmlTag type="div" className="border-b pb-2 border-black">
                        <DynamicHtmlTag
                          type="div"
                          className="sm:flex-col-reverse lg:flex-row flex sm:justify-center lg:justify-center bg-gray-600 px-1 lg:px-3 py-2 rounded-lg">
                          <DynamicHtmlTag type="div" className="flex patient-dashboard-consultations-dropdown sm:w-full lg:w-[40%] sm:mt-5 lg:mt-0">
                            <CustomButton
                              className={`px-1 py-1 font-bold text-3xs md:text-[1.5vw] lg:text-[.5vw] xl:text-[.6vw] border-0 bg-white rounded-md text-black flex gap-2 sm:m-auto items-center ${
                                isRowOpen ? "drop-icon" : ""
                              }`}
                          ...
                          <DynamicHtmlTag
                            type="div"
                            className="flex justify-center lg:justify-between items-center gap-4 lg:gap-6 custom-light-tooltip">
                            <CustomButton
                              onClick={openJoinMeetingModal}
                              className="px-3 py-1 text-3xs md:text-[1.5vw] lg:text-[.5vw] xl:text-[.6vw] border-0 bg-green-100 rounded-3xl text-white flex gap-2 items-center">
                            ...
                            <CustomButton
                              ...
                              className="px-3 py-1 text-3xs md:text-[1.5vw] lg:text-[.5vw] xl:text-[.6vw] border-0 bg-sky-700 rounded-3xl text-white flex gap-1 justify-center items-center">
                        ...
                        {isRowOpen && doclist.length == 0 ? (
                          ...
                          doclist.map((doc: any, index: number) => (
                            <DynamicHtmlTag type="div" key={index}>
                              <DynamicHtmlTag type="div" className="mt-2 flex justify-between px-5 py-2 border-t border-black">
                                <DynamicHtmlTag type="div">
                                  <DynamicHtmlTag type="p" className=" text-3xs md:text-[1.5vw] lg:text-[.5vw] xl:text-[.6vw] font-semibold">
